...
const replace = {
  ...
  "card.leader.agent.yin:codex.vigil/brother_milor.omega" : "card.leader.agent.yin:homebrew.little-omega/brother_milor",
  "card.leader.hero.yin:pok/dannel_of_the_tenth" : "card.leader.hero.yin:homebrew.little-omega/dannel_of_the_tenth",
  "card.leader.hero.yin:codex.vigil/dannel_of_the_tenth.omega" : "card.leader.hero.yin:homebrew.little-omega/dannel_of_the_tenth",
};
...
const technologies = [{
  ...
  },
  {
    ...
    cardNsid:
        "card.technology.yellow.yin:homebrew.little-omega/yin_spinner",
    type: "Green",
