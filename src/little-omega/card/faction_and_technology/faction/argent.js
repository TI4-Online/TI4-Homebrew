...
const replace = {
  "card.promissory.argent:pok/strike_wing_ambuscade" : "card.promissory.argent:homebrew.little-omega/strike_wing_ambuscade"
};
...
const unitModifiers = [
    {
        ...
        owner: "self",
        priority: "choose",
        triggerNsid: "card.promissory.argent:homebrew.little-omega/strike_wing_ambuscade",
        filter: (auxData) => {
            return (
