...
world.TI4.homebrew.inject({
    ...
    replace:
    {
        ...
        "card.action:base/maneuvering_jets.1": "card.action:homebrew.little-omega/outmaneuver.1",
        "card.action:base/maneuvering_jets.2": "card.action:homebrew.little-omega/outmaneuver.2",
        "card.action:base/maneuvering_jets.3": "card.action:homebrew.little-omega/outmaneuver.3",
        "card.action:base/maneuvering_jets.4": "card.action:homebrew.little-omega/outmaneuver.4",
