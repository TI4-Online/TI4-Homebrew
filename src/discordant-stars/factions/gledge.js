...
const factions = [
  {
    faction: "gledge",
    abilities: ["mantle_cracking", "celestial_reclamation", "deep_mining"],
    commodities: 2,
    home: 3229,
    leaders: {
      agents: ["durran"],
...
const technologies = [
  ...
  },
  {
    ...
    cardNsid:
      "card.technology.unit_upgrade.gledge:homebrew.discordant_stars/orion_platform_2",
    type: "unitUpgrade",
...
const unitAttrs = [
  ...
  },
  {
    ...
    triggerNsid:
      "card.technology.unit_upgrade.gledge:franken.discordant_stars/orion_platform",
  },
  {
    unit: "pds",
    upgradeLevel: 2,
...
const unitModifiers = [
  {
    ...
    applyAll: (unitAttrsSet, auxData) => {
      ...
      const ownMechCount = units.filter(
        (unit) =>
          unit.unit === "mech" &&
          unit.owningPlayerSlot === auxData.self.playerSlot
      );
