module.exports = {
    ...
    "card.action:base/ghost_ship": "card.action:homebrew.action_deck_2/counterintelligence",
    "card.action:base/imperial_rider": "card.action:homebrew.action_deck_2/custodian_support",
    "card.action:base/in_the_silence_of_space": "card.action:homebrew.action_deck_2/cyberwarfare",
    "card.action:base/industrial_initiative": "card.action:homebrew.action_deck_2/deep_cover_operatives",
    "card.action:base/infiltrate": "card.action:homebrew.action_deck_2/deep_space_station",
    "card.action:base/insubordination": "card.action:homebrew.action_deck_2/defectors",
    "card.action:base/intercept": "card.action:homebrew.action_deck_2/defense_installation",
    "card.action:base/leadership_rider": "card.action:homebrew.action_deck_2/defense_rider",
    "card.action:base/lost_star_chart": "card.action:homebrew.action_deck_2/deflection_tactics",
    "card.action:base/lucky_shot": "card.action:homebrew.action_deck_2/disrupt_logistics",
    "card.action:base/mining_initiative": "card.action:homebrew.action_deck_2/early_voting",
